...
from win32more.Windows.UI.Xaml import GridLength, GridLengthHelper, GridUnitType,DependencyObject,Thickness
...
class App(XamlApplication):
	...
	def initHistoryPage(self):
		def pushData():
			from win32more.Microsoft.UI.Xaml.Controls import TextBlock, ToolTip
