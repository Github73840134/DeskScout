...
class ITextRewriter3(ComPtr):
    extends: IInspectable
    _classid_ = 'Microsoft.Windows.AI.Text.ITextRewriter3'
    _iid_ = Guid('{622eb80a-ed1a-5525-80d8-c6e80236a195}')
    @winrt_commethod(6)
    def RewriteCustomAsync(self, text: hstr, customTone: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Microsoft.Windows.AI.Text.LanguageModelResponseResult, hstr]: ...
...
class LanguageModelResponseStatus(Enum, Int32):
    ...
    Error = 6
TextIntelligenceContract: UInt32 = 458752
...
class TextRewriter(ComPtr):
    ...
    @winrt_mixinmethod
    def RewriteCustomAsync(self: win32more.Microsoft.Windows.AI.Text.ITextRewriter3, text: hstr, customTone: hstr) -> win32more.Windows.Foundation.IAsyncOperationWithProgress[win32more.Microsoft.Windows.AI.Text.LanguageModelResponseResult, hstr]: ...
