...
class ContentType:
	plaintext=0x00
	xaml=0x01
# Microsoft you can can shove my Vertical StackPanel up your ass, this is too much code for a fucking popup box that
# i had to move this to a different file to make my code navigatable
