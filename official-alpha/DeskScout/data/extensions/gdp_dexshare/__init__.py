...
class GlucoseDataProvider():
	...
	def login(self,username,password):
		...
		resp = requests.post('https://share2.dexcom.com/ShareWebServices/Services/General/AuthenticatePublisherAccount',json={"accountName":username,'password':password,'applicationId':"d89443d2-327c-4a6f-89e5-496bbb0317db"})
		print("We have liftoff")
		print(resp.status_code,resp.text)
		if resp.status_code == 200:
			resp = requests.post('https://share2.dexcom.com/ShareWebServices/Services/General/LoginPublisherAccountById',json={"accountId":eval(resp.text),'password':password,'applicationId':"d89443d2-327c-4a6f-89e5-496bbb0317db"})
			if resp.status_code == 200:
